package ht.sivgep.pharmacielakay.pharmacie;
...
public class PharmacieActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hashLogin = sharedPreferences.getInt("hashLogin", 0);
        Toast.makeText(getApplicationContext(),typeLogin+"\n"+telephoneLogin+"\n"+hashLogin, Toast.LENGTH_LONG).show();
